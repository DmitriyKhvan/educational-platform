...
import type { CalendarAppointment, CalendarEvent, CalendarEventProcessed } from "@/types";
...
const LessonsCalendar: React.FC<LessonsCalendarProps> = ({ calendarAppointments, getAppointments }) => {
