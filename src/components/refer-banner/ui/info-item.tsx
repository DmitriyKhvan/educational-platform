...
export const InfoItem = ({ info }: InfoItemProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <h4 style={{ color: `rgba(${color},1)` }} className={'text-lg font-bold leading-6'}>
          {title}
        </h4>
        <p style={{ color: `rgba(${color},1)` }} className={'text-[15px] leading-[22px]'}>
          {text}
        </p>
      </div>
    </div>
