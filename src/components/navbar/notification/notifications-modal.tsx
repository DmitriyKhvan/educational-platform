...
const NotificationsModal = ({
  notifications,
  removeNotifications,
}: { notifications: Notification[]; removeNotifications: (type?: string) => void }) => {
  ...
  return (
    <div className="w-full sm:w-[368px]">
      ...
      <span className="block text-center text-sm text-gray-400 mb-4">{lastLabel}</span>
      ...
      <div className="m-5">
        {!!notifications?.length && (
          ...
          >
            ...
            <Button theme="gray" onClick={() => setOpenDialog(false)} className="w-full">
