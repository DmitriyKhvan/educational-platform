...
export const ReferBanner = () => {
  return (
    <div className="w-full rounded-lg p-[22px] bg-[#19BBFE] bg-[url('src/assets/images/referBanner.png'),_url('src/assets/images/LogoBg.svg')] bg-[position:right_20px_center,_right_center] bg-[length:auto_100%] bg-no-repeat">
