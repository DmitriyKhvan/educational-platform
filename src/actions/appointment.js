...
export function createAppointment(data) {
  ...
  function failure(error) {
    return { type: ActionTypes.CREATE_APPOINTMENT_INFO.FAILURE, payload: error }
  }
}
...
export function cancelAppointment(id) {
  ...
  function failure(error) {
    return { type: ActionTypes.CANCEL_APPOINTMENT_INFO.FAILURE, payload: error }
  }
}
...
export function updateAppointment(id, data) {
  ...
  function failure(error) {
    return { type: ActionTypes.UPDATE_APPOINTMENT_INFO.FAILURE, payload: error }
  }
}
...
export function approveAppointment(data) {
  ...
  function success(data) {
    return { type: ActionTypes.APPROVE_APPOINTMENT_INFO.SUCCESS, payload: data }
  }
  function failure(error) {
    return {
