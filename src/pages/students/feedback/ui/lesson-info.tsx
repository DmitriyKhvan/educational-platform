...
function LessonInfo({
  ...
  return (
    <div className="mt-6 space-y-6">
      ...
      <div>
        <p className="text-color-light-grey text-sm mb-3">{t('mentor', { ns: 'lessons' })}</p>
        <p className="bg-color-dashboard-bg p-4 font-medium text-color-dark-violet text-sm min-h-14 rounded-lg">
      ...
      <div>
        <p className="text-color-light-grey text-sm mb-3">{t('level', { ns: 'lessons' })}</p>
        <p className="bg-color-dashboard-bg p-4 font-medium text-color-dark-violet text-sm min-h-14 rounded-lg">
      ...
      <div>
        <p className="text-color-light-grey text-sm mb-3">{t('duration', { ns: 'feedback' })}</p>
        <p className="bg-color-dashboard-bg p-4 font-medium text-color-dark-violet text-sm min-h-14 rounded-lg">
