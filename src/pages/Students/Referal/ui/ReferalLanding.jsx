      ...
      <footer className="w-full bg-color-dark-violet z-10 absolute bottom-0 p-5 md:px-20 md:py-6">
        ...
        <section className="space-y-5 md:space-y-0 md:flex md:gap-4 justify-between items-start">
          <div className="text-sm space-y-5">
            ...
            <p className="flex items-center gap-2 hover:text-color-purple hover:cursor-pointer">
              <IoMdMail className="text-xl" /> support@naonow.com
            </p>

            <p className="flex items-center gap-2 hover:text-color-purple hover:cursor-pointer">
              <FaPhone className="text-xl" /> 02-3498-6970
            </p>

            <p className="flex items-center gap-2 hover:text-color-purple hover:cursor-pointer">
              <FaMapMarkerAlt className="text-xl" /> 325 N. Saint Paul Street,
              Suite 3100, Dallas, TX 75201
            </p>
          </div>
          <div>
            <div className="hidden md:block mb-4">
              ...
              <ul className="text-sm space-y-2">
                <li className="hover:text-color-purple transition-colors">
                  <a
