  ...
  return (
    <div className="relative rounded-[10px] bg-color-banner-green h-[200px] p-6 overflow-hidden">
      ...
      <div className="flex flex-col gap-6 z-30">
        <div className="flex flex-col gap-4 sm:items-start z-30">
          <p className="text-[22px] font-bold tracking-tight text-white leading-normal">
            {t('schedule_card', { ns: 'dashboard' })}
          </p>

          <p className="hidden sm:block text-[15px] text-white tracking-tight">
            {t('student_dashboard_subtitle', { ns: 'dashboard' })}
          </p>
          <p className="sm:hidden text-[15px] text-white tracking-tight">
            {t('lets_learn_together', { ns: 'dashboard' })}
          </p>
        </div>
        <div className="flex justify-start gap-3 md:w-11/12 z-30">
          <Link
