...
export default function FeedbackLessonModal({isOpen, closeModal, modalState = ""}) {
          ...
          <article>
            ...
            <section className='summary_lesson'>
              <div>
                ...
                <textarea value={"Арно́льд Ало́ис Шварцене́ггер — американский культурист, предприниматель, киноактёр, продюсер, государственный и политический деятель австрийского происхождения."}>
