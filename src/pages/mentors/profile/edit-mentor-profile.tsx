...
import SampleModal from '@/pages/mentors/profile/sample-modal';
import { MUTATION_UPDATE_MENTOR } from '@/shared/apollo/graphql';
import Stick from '@/shared/assets/images/stick.png';
...
const EditMentorProfile = () => {
  ...
  return (
    <div>
        ...
        <section>
          ...
          <div>
            <div className="w-[440px] bg-white mt-[85px] border border-color-border-grey rounded-[10px] pt-[15px] px-[30px] pb-[30px]">
              <img className="w-[33px] h-[33px] object-contain" src={Stick} alt="" />
      ...
      {
        <ModalWrapper isOpen={showSample} closeModal={closeSampleModal} paddingContent="0">
          <SampleModal />
        </ModalWrapper>
      }

      {
        <ModalWrapper isOpen={showEditAvatar} closeModal={closeEditAvatarModal} paddingContent="0">
