...
const AddStudentProfile = () => {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full sm:max-w-[440px] m-auto">
        ...
        <Button className="w-full my-8 sm:my-10 sm:text-[15px] h-[58px] sm:h-16" type="submit">
